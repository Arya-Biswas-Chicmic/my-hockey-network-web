...
export const API_ENDPOINTS = {
  AUTH: {
    ...
    ORG_VERIFY_INVITE: '/auth/organization/verify-invite',
    ORG_ACCEPT_INVITE: '/auth/organization/accept-invite',
    ASSOC_VERIFY_INVITE: '/auth/association/verify-invite',
    ASSOC_ACCEPT_INVITE: '/auth/association/accept-invite',
    VERIFY_PASSWORD_RESET: (target: 'organization' | 'association') => `/auth/${target}/verify-password-reset`,
    RESET_PASSWORD: (target: 'organization' | 'association') => `/auth/${target}/reset-password`,
  },
  RELATIONSHIPS: {
    BASE: '/relationships',
