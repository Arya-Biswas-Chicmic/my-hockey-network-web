  ...
  return (
    <AppShell activeTab={activeNavTab} onTabChange={handleTabChange} onLogout={onLogout}>
      ...
      {selectedGroupId ? (
        ...
        <main className="mhn-groups-main-container max-w-[1240px] w-full my-6 mx-auto px-6 flex flex-col gap-6 box-border lg:my-0 lg:min-h-0 lg:flex-1 lg:py-6 lg:overflow-y-auto pb-16">
